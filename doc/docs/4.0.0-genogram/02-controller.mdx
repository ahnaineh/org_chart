...
|-----------|------|----------|---------|-------------|
| `items` | `List<T>` | ✅ | - | The list of family members to display |
| `idProvider` | `String Function(T)` | ✅ | - | Function that returns a unique ID for each person |
| `fatherProvider` | `String? Function(T)` | ✅ | - | Function that returns the father's ID |
| `motherProvider` | `String? Function(T)` | ✅ | - | Function that returns the mother's ID |
| `spousesProvider` | `List<String>? Function(T)` | ✅ | - | Function that returns spouse IDs |
| `genderProvider` | `int Function(T)` | ✅ | - | Function that returns gender (0=male, 1=female) |
| `boxSize` | `Size` | ❌ | `Size(150, 150)` | Size of each person node |
| `spacing` | `double` | ❌ | 30 | Horizontal spacing between siblings |
| `spouseSpacing` | `double?` | ❌ | `spacing` | Spacing between spouses in a couple group |
| `runSpacing` | `double` | ❌ | 60 | Vertical spacing between generations |
...
Next: Learn about the [Genogram Widget →](/docs/4.0.0-genogram/03-widget)
